...
public class Libro {
    ...
    private Integer nroEjemplares, nroEjemplaresPrestados;

    public Libro() {
    }

    public Libro(String titulo, String autor, Integer nroEjemplares, Integer nroEjemplaresPrestados) {
        this.titulo = titulo;
        this.autor = autor;
    ...
    public String toString() {
        return "Titulo='" + titulo + '\'' +
                ...
                ", Nro de Ejemplares Prestados=" + nroEjemplaresPrestados;
    }
}
